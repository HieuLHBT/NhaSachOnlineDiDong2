...
public class DoiMatKhauActivity extends AppCompatActivity {
    EditText layoutTDMK_edXacNhanMatKhauMoi, layoutTDMK_edMatKhauMoi, layoutTDMK_edMatKhauHienTai;
    Button layoutTDMK_btnDoiMatKhau;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thaydoimatkhau_layout);
