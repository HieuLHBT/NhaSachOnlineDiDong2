...
public class ChiTietDonDaNhan {
    ...
    public ChiTietDonDaNhan() {
    }

    public ChiTietDonDaNhan(String maDonHang, String tenKhachHang, String tenNhanVienDuyet, String tenNhanVienGiao, String thoiGianLap, int phiVanChuyen, int giamGia, String diaChiGiao, String hinhThucThanhToan, String trangThaiDon, int tongTienThanhToan) {
        this.maDonHang = maDonHang;
        this.tenKhachHang = tenKhachHang;
        this.tenNhanVienDuyet = tenNhanVienDuyet;
        this.tenNhanVienGiao = tenNhanVienGiao;
